...
Локальный цикл работы с Git

Внести изменения в файлы проекта.

git status — проверить текущие изменения.

git add . — добавить изменения в индекс.

git commit -m "Описание" — зафиксировать изменения локально.

git push — отправить коммиты в удалённый репозиторий.

Повторять при каждой итерации разработки.

Правила веток:

git feature/DV-X где X - номер урока
